...
class Blockchain(object):
    ...
    def new_transactions( self , sender , recipiant , ammount ):
        transaction = {
            'sender': sender,
            'recipiant': recipiant,
            'ammount': ammount
        ...
        return self.last_block['transactions']
...
@app.route('/useridupdate', methods=['POST'])
def cross_origin_userid_update():
